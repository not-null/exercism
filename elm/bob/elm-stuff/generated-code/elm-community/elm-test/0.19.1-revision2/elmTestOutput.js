...
var $author$project$Bob$isYelling = function (remark) {
	return A2($elm$core$String$any, $elm$core$Char$isAlpha, remark) && A2(
		$elm$core$String$all,
		$elm$core$Char$isUpper,
		A2($elm$core$String$filter, $elm$core$Char$isAlpha, remark));
};
var $elm$core$String$length = _String_length;
var $author$project$Bob$hey = function (remark) {
	return (!$elm$core$String$length(
		$elm$core$String$trim(remark))) ? 'Fine. Be that way!' : ($author$project$Bob$isYelling(remark) ? (A2(
		$elm$core$String$endsWith,
		'?',
		$elm$core$String$trim(remark)) ? 'Calm down, I know what I\'m doing!' : 'Whoa, chill out!') : (A2(
		$elm$core$String$endsWith,
		'?',
		$elm$core$String$trim(remark)) ? 'Sure.' : 'Whatever.'));
};
...
var $author$project$Test$Generated$Main3024765287$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/erik/snap/exercism/5/exercism/elm/bob/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 198958754695229
	},
...
_Platform_export({'Test':{'Generated':{'Main3024765287':{'init':$author$project$Test$Generated$Main3024765287$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-53742.sock";
